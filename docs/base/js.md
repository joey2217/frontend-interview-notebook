...
## 2. JavaScript 有几种类型的值你能画一下他们的内存图吗
...
[《JavaScript 有几种类型的值能否画一下它们的内存图；》](https://blog.csdn.net/jiangjuanjaun/article/details/80327342)

## 3. 什么是堆什么是栈它们之间有什么区别和联系
...
详细资料可以参考：
[《什么是堆什么是栈他们之间有什么区别和联系》](https://www.zhihu.com/question/19729973)
...
## 42. 事件是什么IE 与火狐的事件机制有什么区别 如何阻止冒泡
...
## 67. requireJS 的核心原理是什么(如何动态加载的如何避免多次加载的如何 缓存的)
...
## 84. 把 script 标签放在页面的最底部的 body 封闭之前和封闭之后有什么区别浏览器会如何解析它们
...
## 108. 什么是 MVVM 比之 MVC 有什么区别什么又是 MVP
